Hi, Reviewers! hope this helps.

Run available unittests from VS terminal using command: python manage.py test tests/
Don't forget to activate virtual eviroment and cd into littlelemon directory before running unit-tests command.
